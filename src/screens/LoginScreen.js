...
const LoginScreen = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <SignBtn title={'Log In'} />
            <View style={{ height: height * 0.055, justifyContent: 'center' }} >
                <Text style={{ fontSize: 15, fontFamily: 'AlbertSans-Medium', color: colors.text }}>Forgot the password?</Text>
            </View>
